...
const secciones = {
    ...
    'Reservas': `
        <h1>Reservas</h1>
        <p>Aquí puedes gestionar las reservas de los clientes.</p>
    `,
    'Informes de Pagos': `
        <h1>Informes de Pagos</h1>
        <p>Consulta el historial de pagos y facturación.</p>
    `,
    'Servicios': `
        <h1>Servicios</h1>
        <p>Aquí puedes ver los servicios programados y sus detalles.</p>
    `,
    'Administrador de Empleados': `
        <h1>Administrador de Empleados</h1>
        <p>Gestiona la información y los permisos de los empleados.</p>
    `,
    'Noticias': `
        <h1>Noticias</h1>
        <p>Últimas novedades y noticias del spa.</p>
    `
};
